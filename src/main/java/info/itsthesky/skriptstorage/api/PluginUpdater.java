...
public class PluginUpdater {
    ...
    public static PluginUpdater create(final JavaPlugin plugin, final String repoAuthor, final String repoName) {
        if (plugin == null || repoAuthor == null || repoName == null)
            throw new IllegalArgumentException("The plugin instance, repo author or name cannot be null.");
    ...
    public static PluginUpdater create(final JavaPlugin plugin, final Long resourceID) {
        if (plugin == null || resourceID == null)
            throw new IllegalArgumentException("The plugin instance or the resource ID cannot be null.");
    ...
    /**
     * Get the latest version URL of this {@link PluginUpdater}, which lend on the latest version of the plugin.
     */
    public String getLatestVersionURL() {
        return getSite().getLatestURL(getArguments());
    }
    ...
    private static String getURLContent(String input) throws IOException {
        ...
        try {
            ...
            Bukkit.getLogger().warning("Unable to find latest version from: " + url + ", is there no release / update?");
            return "";
        }
    ...
    public enum UpdateSite {
        ...
        public String getLatestURL(Object... arguments) {
            final String url = String.format(getApiRequestURL(), arguments);
            if (this.equals(SPIGOTMC))
                return url;
